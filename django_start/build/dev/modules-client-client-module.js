...
var EmployeesDetailComponent = /** @class */ (function () {
    ...
    EmployeesDetailComponent.prototype.onAddEmployee = function () {
        ...
        this.apiService.post(this.apiService.apiUrl + "/sell-goods/customers/", this.editing_Employee).subscribe(function (data) {
            _this.onSuccess.emit();
    ...
    EmployeesDetailComponent.prototype.onUpdateEmployee = function () {
        var _this = this;
        this.isSubmitting = true;
        this.apiService.update(this.apiService.apiUrl + "/sell-goods/customers/" + this.editing_Employee.id, this.editing_Employee).subscribe(function (data) {
            _this.onSuccess.emit();
            _utils_utilities__WEBPACK_IMPORTED_MODULE_2__["Utils"].notifySuccess('Customer has been added successfully.');
            _this.isSubmitting = false;
        }, function (error) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _models__WEBPACK_IMPORTED_MODULE_4__["EmployeeDetailModel"]),
        __metadata("design:paramtypes", [_models__WEBPACK_IMPORTED_MODULE_4__["EmployeeDetailModel"]])
...
var EmployeesComponent = /** @class */ (function () {
    ...
    EmployeesComponent.prototype.loadEmployee = function () {
        var _this = this;
        this.isLoading = true;
        this.apiService.get(this.apiService.apiUrl + "/employees").subscribe(function (data) {
            _this.dataSource = data;
            _this.isLoading = false;
        }, function () {
            _this.isLoading = false;
    ...
    EmployeesComponent.prototype.onAddEmployee = function () {
        ...
        this.selectedEmployee = new _models__WEBPACK_IMPORTED_MODULE_5__["EmployeeDetailModel"]();
    ...
    EmployeesComponent.prototype.onDeleteEmployeeTemplate = function (employee) {
        ...
        Object(devextreme_ui_dialog__WEBPACK_IMPORTED_MODULE_2__["confirm"])(message, title).then(function (result) {
            if (result) {
                _this.apiService.delete(_this.apiService.apiUrl + "/employees]/" + employee, employee)
                    .subscribe(function () {
                    _utils_utilities__WEBPACK_IMPORTED_MODULE_3__["Utils"].notifySuccess('Customer has been deleted successfully');
                    _this.loadEmployee();
                }, function (error) {
